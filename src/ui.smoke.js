...
clickBtn('Close');
clickBtn('Meta-Science Lab');
check('Meta-Science Lab opens (p-curve)', modalText().includes('Meta-Science Lab') && q('svg').length > 0);
clickBtn('Funnel'); check('funnel tab renders', q('svg').length > 0);
clickBtn('Power'); check('power tab renders', /per group/.test(modalText()));
clickBtn('Close');
