...
from the modular sources in `src/`. Edit `src/`, never `index.html`. One deliberate exception
to self-containment: **`intro.mp4`** (the first-visit opening video, 2.6 MB — too big to inline)
